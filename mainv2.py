# https://github.com/tractorjuice/STGPT/blob/main/app.py
...
st.set_page_config(page_title="AI Executive Order Agent")
st.sidebar.title("Chat with the AI Executive Order")
st.sidebar.divider()
st.sidebar.markdown("Using brand new gpt-4-1106-preview API that includes agents")
